...
/// Paints translated (or original) text for each detected [TextRegion] on
/// top of an already-rendered manga page.
///
/// Unlike the PoC version this painter does **not** draw the underlying page
/// image itself; it is meant to be stacked directly above a `MangaImage`
/// widget inside the reader, using [imageSize] (the original, unscaled
/// dimensions of that image) purely to translate region coordinates into the
/// painter's own [Size] during scaling.
///
